...
<p>
     ...
     {switch match=$:item_previous|lt(0) }
		{case match=0}
		<span class="previous">
			<a href={concat($page_uri,$:item_previous|gt(0)|choose('',concat($:offset_text,$:item_previous)),$:view_parameter_text,$page_uri_suffix)|ezurl} title="{"Previous"|i18n("design/admin/navigator")}">
				<img src={"pictos/left_arrow.png"|ezimage()} width="10" height="15" alt="{"Previous"|i18n("design/admin/navigator")}" />
			</a>
		</span>
		{/case}
		{case}
		<span class="previous">
			<img class="disabled" src={"pictos/left_arrow.png"|ezimage()} width="10" height="15" alt="{"Previous"|i18n("design/admin/navigator")}" />
		</span>
		{/case}
	{/switch}
	<span class="pages">
	...
	{switch match=$:item_next|lt($item_count)}
		{case match=1}
		<span class="next">
			<a href={concat($page_uri,$:offset_text,$:item_next,$:view_parameter_text,$page_uri_suffix)|ezurl} title="{"Next"|i18n("design/admin/navigator")}">
				<img src={"pictos/right_arrow.png"|ezimage()} width="10" height="15" alt="{"Next"|i18n("design/admin/navigator")}" />
			</a>
		</span>
		{/case}
		{case}
		<span class="next">
			<img class="disabled" src={"pictos/right_arrow.png"|ezimage()} width="10" height="15" alt="{"Previous"|i18n("design/admin/navigator")}" />
		</span>
		{/case}
    {/switch}
