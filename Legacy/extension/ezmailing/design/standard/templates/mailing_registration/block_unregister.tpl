...
<div class="ezmailing_registration">
    <div class="attribute-header">
        <h2>{'Unregister'|i18n( 'extension/ezmailing/text' )}</h2>
    </div>
    <form method="post" action={"mailing/unregister"|ezurl} >
        {def
        ...
        <label>{'Your email'|i18n( 'extension/ezmailing/text' )}</label><input type="text" value="{$email|whash}" name="email" />
        <ul>
        ...
        <input type="submit" class="button"  name="MailingUnregisterButton" value={'Unregister'|i18n( 'extension/ezmailing/text' )} />
    </form>
</div>